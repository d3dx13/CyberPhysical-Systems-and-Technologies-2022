...
```
    ...
    Временной интервал (14.373339259498888, 14.473339259498887)
...
```
    ...
    tensor([[ 1.0000e+00, -1.3807e-19],
            [-2.0227e-15,  1.0000e+00]], device='cuda:0', dtype=torch.float64)
...
```
    ...
    tensor([[9.4589e-04],
            [9.9347e-01]], device='cuda:0', dtype=torch.float64)
...
```
    ...
    Вычисленное значение R =  6.901786595835624  Ом
    Вычисленное значение L =  1.0572104700392033  Гн
...
```
    ...
    R =  6.9017865958356  Ohm
    L =  1.0537558096901563  Hn
