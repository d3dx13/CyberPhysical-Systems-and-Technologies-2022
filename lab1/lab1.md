...
```
    ...
    Временной интервал (79.79110504590288, 79.89110504590288)
...
```
    ...
    tensor([[ 1.0000e+00,  3.0917e-20],
            [-4.3611e-15,  1.0000e+00]], device='cuda:0', dtype=torch.float64)
...
```
    ...
    tensor([[4.8883e-04],
            [9.9023e-01]], device='cuda:0', dtype=torch.float64)
...
```
    ...
    Вычисленное значение R =  19.98755669979202  Ом
    Вычисленное значение L =  2.045703037495836  Гн
...
```
    ...
    R =  19.987556699792123  Ohm
    L =  2.035692905100104  Hn
