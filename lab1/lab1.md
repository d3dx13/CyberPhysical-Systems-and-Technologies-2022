...
```
    ...
    Временной интервал (8.59141603330683, 8.69141603330683)
...
```
    ...
    tensor([[ 1.0000e+00, -5.3998e-21],
            [-6.6613e-16,  1.0000e+00]], device='cuda:0', dtype=torch.float64)
...
```
    ...
    tensor([[1.9055e-04],
            [9.9322e-01]], device='cuda:0', dtype=torch.float64)
...
```
    ...
    Вычисленное значение R =  35.58468661788794  Ом
    Вычисленное значение L =  5.248027656893663  Гн
...
```
    ...
    R =  35.58468661788761  Ohm
    L =  5.230215138045228  Hn
