...
```
    ...
    Временной интервал (24.062276446910012, 24.162276446910013)
...
```
    ...
    tensor([[ 1.0000e+00, -5.0526e-19],
            [-3.5735e-15,  1.0000e+00]], device='cuda:0', dtype=torch.float64)
...
```
    ...
    tensor([[6.7484e-04],
            [9.9160e-01]], device='cuda:0', dtype=torch.float64)
...
```
    ...
    Вычисленное значение R =  12.450710406261667  Ом
    Вычисленное значение L =  1.4818331382019163  Гн
...
```
    ...
    R =  12.450710406261644  Ohm
    L =  1.4755990283618157  Hn
