...
```
    ...
    Временной интервал (61.33255117143824, 61.43255117143824)
...
```
    ...
    tensor([[ 1.0000e+00, -1.3464e-18],
            [ 9.0553e-16,  1.0000e+00]], device='cuda:0', dtype=torch.float64)
...
```
    ...
    tensor([[0.0015],
            [0.9904]], device='cuda:0', dtype=torch.float64)
...
```
    ...
    Вычисленное значение R =  6.595310622490413  Ом
    Вычисленное значение L =  0.6867530315297513  Гн
...
```
    ...
    R =  6.595310622490455  Ohm
    L =  0.6834500724837678  Hn
