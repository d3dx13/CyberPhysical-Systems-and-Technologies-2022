...
```
    ...
    Временной интервал (69.12949221392952, 69.22949221392952)
...
```
    ...
    tensor([[ 1.0000e+00, -1.6411e-21],
            [-1.2969e-14,  1.0000e+00]], device='cuda:0', dtype=torch.float64)
...
```
    ...
    tensor([[1.7778e-04],
            [9.9317e-01]], device='cuda:0', dtype=torch.float64)
...
```
    ...
    Вычисленное значение R =  38.40039478900881  Ом
    Вычисленное значение L =  5.624798791902746  Гн
...
```
    ...
    R =  38.40039478900889  Ohm
    L =  5.605576673047219  Hn
