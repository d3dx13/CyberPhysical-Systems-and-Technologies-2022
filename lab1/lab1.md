...
```
    ...
    Временной интервал (80.93001319042764, 81.03001319042764)
...
```
    ...
    tensor([[ 1.0000e+00, -4.9763e-21],
            [ 9.3744e-15,  1.0000e+00]], device='cuda:0', dtype=torch.float64)
...
```
    ...
    tensor([[2.0336e-04],
            [9.9329e-01]], device='cuda:0', dtype=torch.float64)
...
```
    ...
    Вычисленное значение R =  33.00091044204834  Ом
    Вычисленное значение L =  4.91740727690987  Гн
...
```
    ...
    R =  33.00091044204832  Ohm
    L =  4.900888303629814  Hn
