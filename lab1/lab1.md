...
```
    ...
    Временной интервал (35.01034915891361, 35.110349158913614)
...
```
    ...
    tensor([[1.0000e+00, 1.1244e-19],
            [3.4001e-16, 1.0000e+00]], device='cuda:0', dtype=torch.float64)
...
```
    ...
    tensor([[7.0255e-04],
            [9.9346e-01]], device='cuda:0', dtype=torch.float64)
...
```
    ...
    Вычисленное значение R =  9.306629187792126  Ом
    Вычисленное значение L =  1.4233859712836732  Гн
...
```
    ...
    R =  9.306629187792053  Ohm
    L =  1.418727569191738  Hn
