...
\begin{document}
    ...
    \title{Лабораторная работа №1: Введение в анализ данных с помощью Python \\ По предмету "Киберфизические системы и технологии"}
    \author{работу выполнил: Жидков Артемий Андреевич \\ группа: R4136с}
    \date{преподаватель: Афанасьев Максим Яковлевич \\ дата: сентябрь 2022}
    \maketitle
